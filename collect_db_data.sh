...
usage() {
    ...
    echo "  • COMPLETE active sessions (excludes SYS/SYSTEM)"
    echo "  • ENHANCED tablespace collection"
...
COMBINED_OUTPUT_FILE="./db_health_data_${INSTANCE_NAME}_${TIMESTAMP}.txt"
...
ORDER BY inst_id, status;"
    ...
    connection_data=$(execute_sql_simple "$CONNECTION_SQL" "Connection Metrics (Filtered)")
...
# POLISHED: Enhanced tablespace monitoring
